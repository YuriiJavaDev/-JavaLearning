...
- [Task 63 V0.1: Rune Decryptor V0.1](https://github.com/YuriiJavaDev/JavaBasics_Task_63_V0.1) — This project simulates the decryption of an ancient rune. It focuses on the relationship between the **char** data type and its underlying **ASCII** numeric representation, demonstrating how Java handles character encoding.
